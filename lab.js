...
favoriteThings.car = 'Nissan Pathfinder'
...
const ingredients = (macros) => {
  ...
  let nutriArr = []
  nutriArr.push(bread)
  nutriArr.push(avocado)
  nutriArr.push(meat)
  console.log(nutriArr)
}
let macros = {
  carb: 'carb',
  fat: 'fat',
...
const doug = new Cat('Doug', 3, 'Black')
...
class Wizard {
  constructor(wizName, wizAge, wizFavoriteSpell){
    this.name = wizName
    this.age = wizAge
    this.favoriteSpell = wizFavoriteSpell
  }
  castSpell() {
...
const borgnar = new Wizard('Borgnar', '831', `'Summon Doug'`)
console.log(borgnar)
borgnar.castSpell()
...
let phoneOne = new Phone('Apple', 'iPhone', 128, 'red', 1000)
